      ...
      <Grid item xs={12}>
        <Card>
          ...
          <CardContent>
            ...
            <Typography>
            RaychemPlannerProfile RaychemPlannerProfile RaychemPlannerProfile RaychemPlannerProfile RaychemPlannerProfile
...
export default RaychemPlannerProfile
