...
const schema = yup.object().shape({
  currentPassword: yup.string().min(8, 'Current password must be at least 8 characters long').required('Current password is required'),
  newPassword: yup
    .string()
          ...
          <Grid container spacing={6}>
            <Grid item xs={12} md={6}>
              ...
              <Grid item xs={12} sx={{ mb: 5, }}>
                <Typography sx={{ fontWeight: 600, color: 'text.secondary', mb: 5 }}>Password Requirements:</Typography>
                <Box component='ul' sx={{ pl: 4, mb: 0, '& li': { mb: 1, fontSize: '0.875rem', color: 'text.secondary' } }}>
              ...
              <Grid item xs={12} sx={{ mb: 5, display: 'flex', justifyContent: 'flex-end' }} >
            ...
            <Grid item md={6} xs={12} sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'center', mb: -10 }}>
              <img alt='avatar' height={350} src='/images/rpg-images/change-password-img.png' />
            </Grid>
          </Grid>
        </form>
      </CardContent>
